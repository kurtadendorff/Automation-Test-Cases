...
Dealer Reports
    Click Element   xpath=//*[@id="isc_3Mtable"]/tbody/tr[1]/td[2]/div

Dealer Reports v3
    Click Element   xpath=//*[@id="isc_3Ttable"]/tbody/tr[10]/td[3]/div
    Sleep  15s
...
Select Search Dealer Option
    ...
    Sleep  5s
Select Dealer
    Click Element  xpath=//*[@id="dealer_search_results"]/tbody/tr[2]/td[3]/input
