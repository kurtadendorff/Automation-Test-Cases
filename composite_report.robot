...
Composite Reports
    Click Element   xpath=//*[@id="isc_3Mtable"]/tbody/tr[2]/td[2]/div
    Sleep  5s

Composite Reports v3
    Click Element   xpath=//*[@id="isc_3Ttable"]/tbody/tr[9]/td[3]/div
    Sleep  5s
...
Click Ok
   Click Element   xpath=//*[@id="btn_dealer_list_ok"]

Select Benchmark Search Option
    Click Element  xpath=//*[@id="comp-bm-selection"]
    Sleep  5s
